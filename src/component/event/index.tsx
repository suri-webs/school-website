...
export default function Event() {
    ...
    return (
        <section className="w-full py-10 flex flex-col gap-8 justify-center items-center bg-gray-50">
           <div className="flex flex-col justify-center items-center w-[84%] max-md:w-full px-2">
            ...
            <div className="w-[84%] grid grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-8">
                {eventData.map((event, index) => (
                    <div
                        key={index}
                        className="w-full max-w-[380px] h-[400px]  mx-auto flex flex-col bg-white rounded-[10px] shadow-md overflow-hidden"
                    >
